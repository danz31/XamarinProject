...
namespace App2
{
	...
	public partial class MasssageCalendar : ContentPage
	{
		public MasssageCalendar ()
		{
			InitializeComponent();
		    ...
		    SfCalendar massageCalendar = new SfCalendar();
		    ...
		    massageCalendar.BlackoutDates = blackDates;
		    ...
		    massageCalendar.MonthViewSettings = monthViewSettings;

		    this.Content = massageCalendar;
        }
	}
}