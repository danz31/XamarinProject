...
namespace App2
{
	...
	public partial class DulaCalendar : ContentPage
	{
		public DulaCalendar ()
		{
			InitializeComponent ();
		    ...
		    SfCalendar DulaCalendar = new SfCalendar();
		    ...
		    DulaCalendar.BlackoutDates = blackDates;
		    ...
		    DulaCalendar.MonthViewSettings = monthViewSettings;

		    this.Content = DulaCalendar;
        }
	}
}